...
public class RunRequest {
    ...
    public RunRequest(String code, String language, int timeLimitMs,
                      int memoryLimitMb, String input) {
        this.code = code;
    ...
    public static class Builder {
        ...
        public Builder timeLimitMs(int t)               { this.timeLimitMs = t; return this; }
        public Builder memoryLimitMb(int m)             { this.memoryLimitMb = m; return this; }
        public Builder input(String input)              { this.input = input; return this; }
        public RunRequest build() {
            return new RunRequest(code, language, timeLimitMs, memoryLimitMb, input);
        }
    }
